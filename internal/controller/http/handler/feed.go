...
type FeedHandler struct {
	service *usecase.FeedService
}

func NewFeedHandler(service *usecase.FeedService) *FeedHandler {
...
func (f *FeedHandler) ListLikesCount(c *gin.Context) {
	...
	var cursor *entity.LikesCountCursor
	if req.LikesCountBefore != nil || req.IDBefore != nil {
		...
		if idBefore == 0 {
			...
			cursor = &entity.LikesCountCursor{
